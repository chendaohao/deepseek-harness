...
// Type-only: the remote-access/tunnel forwarded-event declarations, so the
// allowlist-driven forwarding loop below sees `remote/devices/change` and
// `remote-tunnel/state` in `keyof Events`.
