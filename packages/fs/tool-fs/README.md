...
- **Type refusal reads the file first** — a non-image file is read up to the byte cap before the store's admission refuses it; previously the extension gate refused before any filesystem I/O.
