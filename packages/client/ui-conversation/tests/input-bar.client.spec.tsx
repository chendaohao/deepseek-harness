...
describe('command launcher chrome and control seats', () => {
  it('renders the command launcher and dispatches every empty control seat', () => {
    ...
    expect([...new Set(slotCalls.map(c => c.key))].sort()).toEqual([
      'conversation.composer.dock', 'conversation.input.activity',
      'conversation.input.attachments',
      'conversation.input.left', 'conversation.input.model',
      'conversation.input.overlay', 'conversation.input.permission',
      'conversation.input.plan', 'conversation.input.right',
    ])
