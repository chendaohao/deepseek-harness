 ...
 * standalone page has no CSS-module pipeline). Light-first palette driven by
 * `--m-*` CSS variables; the dark palette applies when the header toggle sets
 * `[data-theme='dark']` on <html>.
 */
export const mobileCss = `:root {
  --m-bg: #f3f5f9;
  --m-bg-raised: #ffffff;
  --m-bg-input: #ffffff;
  --m-border: #dfe4ec;
