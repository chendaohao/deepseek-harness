 ...
 * under `:root` (light) / `:root[data-theme='dark']` (dark). A tiny module
 * store keeps the toggle button and the boot path in sync without threading
 * props through the three view levels.
 */
