 ...
 * the mobile surface between the light (default) and dark palettes. The glyph
 * shows the theme you will switch TO (moon in light mode, sun in dark mode);
 * the choice persists across visits.
 */

import { useSyncExternalStore } from 'react'
import { getMobileTheme, subscribeMobileTheme, toggleMobileTheme } from './theme.ts'
