...
export const en = {
  ...
  modelReasoningInherit: 'Inherit',
  modelReasoningOff: 'No reasoning',
  modelReasoningCustom: 'Custom levels',
  modelReasoningLevel: 'Level {level}',
  modelReasoningWire: 'Wire value',
  modelReasoningOffWire: 'Empty = send nothing',
  modelReasoningHint: '"off" may stay empty: supported, sending nothing. Other levels need the wire value the endpoint expects.',
  modelReasoningEmpty: 'Declare at least one level, disable reasoning, or keep inheritance.',
  modelReasoningOnlyOff: 'Declare at least one thinking level besides "off".',
  modelReasoningWireRequired: 'Every declared level except "off" needs a non-empty wire value.',
  addModel: 'Add model',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '容量',
  modelReasoning: '思考等级',
  modelReasoningInherit: '继承',
  modelReasoningOff: '不思考',
  modelReasoningCustom: '自定义等级',
  modelReasoningLevel: '等级 {level}',
  modelReasoningWire: 'wire 值',
  modelReasoningOffWire: '留空表示不发送参数',
  modelReasoningHint: '「off」可以留空：表示支持思考且不发送参数；其它等级需要填写端点要求的 wire 值。',
  modelReasoningEmpty: '请至少声明一个等级，或选择不思考/继承。',
  modelReasoningOnlyOff: '除「off」外至少声明一个思考等级。',
  modelReasoningWireRequired: '除「off」外的每个已声明等级都需要非空的 wire 值。',
  addModel: '添加模型',
  removeModel: '删除模型',
