...
export const en = {
  ...
  modelInputHint: 'Unchecked declares text-only. Declaring image lets this model receive images.',
  modelInputText: 'Text',
  modelInputImage: 'Images',
  modelInputInvalid: 'A model must accept text.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelInput: '输入模态',
  modelInputHint: '不勾选即声明纯文本。勾选图像后，该模型可以接收图片。',
  modelInputText: '文本',
  modelInputImage: '图像',
  modelInputInvalid: '模型必须接受文本。',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
