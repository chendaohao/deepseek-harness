...
describe('ic_ds_ icon set', () => {
  it('exports the full icon set (46 deepsuite + 21 figma extracts + sixteen product glyphs outside those sets)', () => {
    ...
    // The fork's product glyphs: session pin and manual row reordering.
    expect(iconNames).toEqual(expect.arrayContaining(['IconPinOutline16', 'IconGripVerticalOutline16']))
  })
