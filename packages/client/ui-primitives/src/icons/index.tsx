...
const IconGripVerticalOutlineArtwork = ({ size = 16, className, strokeWidth }: WeightedIconProps) => (
  <svg width={size} height={size} className={className} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" strokeWidth={strokeWidth}>
...
/** Regular IconGripVerticalOutline artwork; its fill-only geometry is weight-independent. */
export const IconGripVerticalOutlineRegular = (props: IconProps) => (
  <IconGripVerticalOutlineArtwork {...props} strokeWidth={ICON_REGULAR_STROKE} />
)

/** Medium IconGripVerticalOutline artwork; it matches Regular because the geometry is fill-only. */
export const IconGripVerticalOutlineMedium = (props: IconProps) => (
  <IconGripVerticalOutlineArtwork {...props} strokeWidth={ICON_MEDIUM_STROKE} />
)
