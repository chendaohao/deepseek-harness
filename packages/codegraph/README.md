...
The plugin is inert for non-indexed workspaces: no message, no server, no tools. Sessions fall back to the `codegraph explore` CLI when the MCP connection fails ([codegraph README](codegraph/README.md)).
