...
| [`vision/`](vision/README.md) | Vision 能力家族：观察能力缝、LLM Provider、请求桥接、面向模型的工具 | Product — stable API |
...
| [`codegraph/`](codegraph/README.md) | CodeGraph 集成：索引工作区的定向清单 + 惰性启动的 MCP 服务器 | 产品：稳定 API |
...
| [`integrations/`](integrations/README.md) | 外部服务集成：订阅配额与用量消费 | 产品：稳定 API |
...
| [`remote/`](remote/README.md) | 远程接入能力：cloudflared 隧道 provider + 配对闸门/反向代理 | 产品：稳定 API |
