    ...
    methods: [
      {
        ...
        parameters: [],
        returns: 'provider writability (false for a forwarded request unless {@link Config.forwardedWrite} is on — the client\'s single writable truth), local-document presence, and one view per namespace.',
