...
来源：[`packages/core/agent-default-model/src/index.ts:49`](../packages/core/agent-default-model/src/index.ts)
...
来源： [`packages/client/connection/src/index.ts:89`](../packages/client/connection/src/index.ts)
...
来源：[`packages/codegraph/codegraph/src/index.ts:68`](../packages/codegraph/codegraph/src/index.ts)
...
来源：[`packages/goal/goal-round-driver/src/index.ts:27`](../packages/goal/goal-round-driver/src/index.ts)
...
需要：`remoteTunnel` · `webServer` · `shellEnv` · `connection`
...
来源：[`packages/remote/remote-access/src/index.ts:47`](../packages/remote/remote-access/src/index.ts)
...
来源：[`packages/remote/remote-tunnel/src/index.ts:86`](../packages/remote/remote-tunnel/src/index.ts)
...
- `@deepseek-ai/dsh-session-pin` — 需要 `sessions`（[`packages/session/session-pin/src/index.ts`](../packages/session/session-pin/src/index.ts)）
...
- `@deepseek-ai/dsh-workspace-ext`（[`packages/bundle/workspace-ext/src/index.ts`](../packages/bundle/workspace-ext/src/index.ts)）
