...
flowchart TD
  ...
  pkg_client_ui_remote --> pkg_client_connection
  pkg_client_ui_remote --> pkg_client_locale
  pkg_client_ui_remote --> pkg_client_ui_renderer
  pkg_client_ui_remote --> pkg_client_ui_sidebar
  pkg_client_ui_remote --> pkg_host_webserver
  ...
  pkg_session_pin --> pkg_invariants
  pkg_session_pin --> pkg_session
  pkg_session_pin --> pkg_session_projection
  ...
  pkg_api_session_controller --> pkg_session_pin
...
| [`session-pin`](../packages/session/session-pin) | `session` | [`invariants`](../packages/runtime-diagnostics/invariants), [`session`](../packages/core/session), [`session-projection`](../packages/session/session-projection) |
