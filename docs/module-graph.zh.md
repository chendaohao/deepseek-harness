...
flowchart TD
  ...
  subgraph group_bundle["packages/bundle"]
    ...
    pkg_web_app["web-app"]
    pkg_workspace_ext["workspace-ext"]
  end
  ...
  pkg_goal_round_driver --> pkg_timeout
...
| [`workspace-ext`](../packages/bundle/workspace-ext) | `bundle` | — |
...
| [`client-ui-remote`](../packages/client/ui-remote) | `client` | — |
...
| [`remote-tunnel`](../packages/remote/remote-tunnel) | `remote` | [`home-paths`](../packages/util/home-paths), [`subprocess`](../packages/subprocess/subprocess) |
...
| [`goal-round-driver`](../packages/goal/goal-round-driver) | `goal` | [`agent`](../packages/core/agent), [`goal`](../packages/goal/goal), [`invariants`](../packages/runtime-diagnostics/invariants), [`llm`](../packages/llm/llm), [`session`](../packages/core/session), [`timeout`](../packages/util/timeout) |
...
| [`remote-access`](../packages/remote/remote-access) | `remote` | [`home-paths`](../packages/util/home-paths), [`host-webserver`](../packages/host/webserver), [`remote-tunnel`](../packages/remote/remote-tunnel), [`shell-env`](../packages/shell/shell-env) |
...
| [`codegraph`](../packages/codegraph/codegraph) | `codegraph` | [`llm`](../packages/llm/llm), [`mcp-client`](../packages/mcp/mcp-client), [`tools`](../packages/core/tools) |
