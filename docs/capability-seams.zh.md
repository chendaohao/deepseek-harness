...
| `ctx.remoteTunnel` | `seam` | [`remote-tunnel`](../packages/remote/remote-tunnel) | - | [`remote-access`](../packages/remote/remote-access) | - | 解析固定的 cloudflared 二进制，并把一个 loopback 端口开放为公网 HTTPS URL；access 服务在其配对闸门之后消费隧道生命周期。 |
