...
| [remote-access.md](remote-access.md) | the remote-access capability: a public HTTPS tunnel into the local Web GUI with phone pairing and revocable device sessions |
